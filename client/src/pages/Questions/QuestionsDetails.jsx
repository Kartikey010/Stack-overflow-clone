...
const QuestionsDetails = () => {
    ...
    // {
    //     answerBody: "Answer hai bhaisahah",
    //         userAnswered: 'sukumar',
    //         answeredOn: "jan 7",
    //         userId: 3,
    // }]
    //}
                     ...
                     <section className='question-details-container'>
                      ...
                      <div className='question-details-container-2'>
                        <div className='question-votes'>
                            <img src={upvote} alt="upvote" width="18" style={{cursor:"pointer"}} onClick={handleUpVote}/>
                            <p>{question.upVote.length - question.downVote.length}</p>
                            <img src={downvote} alt="downVote" width="18" style={{cursor:"pointer"}} onClick={handleDownVote} />
                        </div>
                        <div style={{width: "100%"}}>
